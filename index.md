...
For the neural network approaches explored in the paper, we release 4 saved checkpoints at [https://huggingface.co/mttgdd/oord-models](https://huggingface.co/mttgdd/oord-models). Example use is as below:
